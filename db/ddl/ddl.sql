...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `challenge-db-dev`.`promotion` (
...
CREATE TABLE IF NOT EXISTS `challenge-db-dev`.`user` (
  ...
  CONSTRAINT `fk_user_promotion1`
    ...
    REFERENCES `challenge-db-dev`.`promotion` (`id_promotion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
CREATE TABLE IF NOT EXISTS `challenge-db-dev`.`instance` (
  ...
  CONSTRAINT `fk_Instance_user`
    FOREIGN KEY (`id_user`)
    REFERENCES `challenge-db-dev`.`user` (`id_user`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `challenge-db-dev`.`challenge` (
...
-- -----------------------------------------------------
-- Table `challenge-db-dev`.`challenge_user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `challenge-db-dev`.`challenge_user` (
  ...
  CONSTRAINT `fk_challenge_has_user_challenge1`
    ...
    REFERENCES `challenge-db-dev`.`challenge` (`id_challenge`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `challenge-db-dev`.`challenge_promotion`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `challenge-db-dev`.`challenge_promotion` (
  `id_challenge` INT NOT NULL,
